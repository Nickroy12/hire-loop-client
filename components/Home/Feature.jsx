  ...
  return (
    <div className="w-10/12 mx-auto py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 -mt-12 md:relative bottom-22">
        ...
        {/* Card 1 */}
        <div className="w-full rounded-3xl bg-gradient-to-t from-zinc-800 to-gray-500 border border-violet-500 shadow-[0_0_30px_rgba(139,92,246,0.15)] hover:scale-105 transition-all duration-300 p-6 space-y-12">
